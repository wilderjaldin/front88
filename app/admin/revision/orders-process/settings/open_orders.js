            ...
            <table className="w-full border-collapse bg-white dark:bg-gray-900">
              <thead>
                <tr>
                  ...
                  <SortableHeader col="days"      label={t.days ?? 'Días'}   sort={sort} dir={dir} onSort={onSort} className="text-center" />
                  <SortableHeader col="status"    label={t.status}           sort={sort} dir={dir} onSort={onSort} />
                </tr>
              </thead>
                ...
                {items.map((o, i) => (
                  <tr key={i} className="hover:bg-gray-50 dark:hover:bg-gray-800 transition">
                    ...
                    <td className={tdClass}>
                      <span className="inline-flex items-center rounded-full px-2 py-0.5 text-[10px] font-semibold bg-sky-50 text-sky-600 dark:bg-sky-900/30 dark:text-sky-400">
                        {o.estado}
                      </span>
                    </td>
                  </tr>
