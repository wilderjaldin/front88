...
const URL_DATA_EMAIL = 'repuestosporidentificar/datos-mail-proveedor';
const URL_CONTACTS   = (codPrv) => `repuestosporidentificar/contactos-proveedor/${codPrv}`;
const URL_SEND_EMAIL = 'repuestosporidentificar/enviar-mail-proveedor';
...
const MailToSupplierForm = ({ close, t, order, selected = [] }) => {
  ...
  const getData = async () => {
    try {
      const payload = {
        nroCotizacion: order.nroCotizacion,
  ...
  return (
    <div className="relative space-y-4">
      ...
      {/* Tabla de contactos — visible cuando hay proveedor seleccionado */}
      {selectedSupplier && (
