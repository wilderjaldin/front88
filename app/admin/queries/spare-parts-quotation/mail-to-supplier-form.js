...
const url_data_email = process.env.NEXT_PUBLIC_API_URL + 'repporcotizar/DatosMailPrv';
const url_send_email = process.env.NEXT_PUBLIC_API_URL + 'repporcotizar/EnviarMailPrv';
